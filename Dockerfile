...
RUN mkdir $NVM_DIR && curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.3/install.sh | bash
...
# run yarn update-browserslist-db to update browserslist database
RUN cd $APP \
