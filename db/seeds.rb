...
p App::User.create(email: 'b@a', password:'123456', password_confirmation:'123456', client_id: 1)


p App::User.create(email: 'a@b', password:'123456', password_confirmation:'123456', client_id: 2)
p App::User.create(email: 'b@b', password:'123456', password_confirmation:'123456', client_id: 2)
