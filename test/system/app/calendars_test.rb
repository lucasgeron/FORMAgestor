...
class App::CalendarsTest < ApplicationSystemTestCase
  setup do
  ...
  test "should create calendar" do
    ...
    check "Active" if @app_calendar.active
    fill_in "Client", with: @app_calendar.client_id
    fill_in "Semester", with: @app_calendar.semester
    fill_in "Year", with: @app_calendar.year
